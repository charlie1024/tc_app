...
public class AmbilWarnaKotak extends View {
	...
	@Override protected void onDraw(Canvas canvas) {
		...
		if (paint == null) {
			paint = new Paint();
			luar = new LinearGradient(0.f, 0.f, 0.f, getMeasuredHeight(),
					0xffffffff, 0xff000000, TileMode.CLAMP);
		}
		Shader dalam = new LinearGradient(0.f, 0.f, getMeasuredWidth(), 0.f, 0xffffffff,
				Color.HSVToColor(color), TileMode.CLAMP);
